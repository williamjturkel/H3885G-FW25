...
NotebookLM has a number of features which make it very useful for exploring and learning about a large amount of new material. Here are some ways you can use it...

- **Interesting Stuff**: Try the prompt "_What are three surprising things in these sources?_"
- **Drilling Down**: Use the **Mind Map** feature in the **Studio** panel to get a quick overview of the material in the form of a tree of topics that you can expand and collapse. If you click on any box in the tree, it will submit a matching prompt in the chat window so you can do a deep dive on that topic.
- **Source Guides**: If you click on a source in the **Sources** panel, you will get a guide to the source that includes clickable keywords that can be explored further.
